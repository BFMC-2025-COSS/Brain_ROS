...
#     """속도 데이터 콜백 함수"""
#     global linear_velocity_, last_time_, current_time_, x_, y_, dx, dy
...
#             update_odometry(x_, y_)
#         else:
#             update_odometry(corrected_x, corrected_y)

# def init_position_callback(msg):
#     global x_, y_
#     x_ = msg.x
#     y_ = msg.y

# def update_odometry(cx, cy):
#     """오도메트리 데이터 업데이트 및 퍼블리시"""
#     global x_, y_, dx, dy, heading, current_time_, last_time_, corrected_odom, linear_velocity_

#     # Odometry Correction
#     x_ = alpha * x_ + (1 - alpha) * cx + dx
#     y_ = alpha * y_ + (1 - alpha) * cy + dy
...
# def main():
#     global odom_pub_, current_time_, last_time_, yaw_pub_, x_, y_
...
#     rospy.Subscriber("/init_position", Point, init_position_callback)
